...
class Library{
    ...
    addToLib(title, author, pages, read, about){
    ...
    removeBook(deleteID){
        this.myLib = this.myLib.filter(book => book.id !== deleteID); //Kopie von myLib, die deleteID wird herausgefiltert
        this.showBooks(this.myLib);
    }
...
class Display{
        ...
        static submit(){
            submit.addEventListener("click", (e) => {
                    ...
                    library.addToLib(title, author, pages, read, info);
